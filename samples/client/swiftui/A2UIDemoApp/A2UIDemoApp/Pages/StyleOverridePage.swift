...
struct StyleOverridePage: View {
    ...
    {"surfaceUpdate":{"surfaceId":"main","components":[{"id":"root","component":{"Card":{"child":"col"}}},{"id":"col","component":{"Column":{"children":{"explicitList":["title","body","row_icon","btn"]}}}},{"id":"title","component":{"Text":{"text":{"literalString":"Welcome"},"variant":"h2"}}},{"id":"body","component":{"Text":{"text":{"literalString":"Toggle the switch to see how style modifiers restyle A2UI components without changing the server JSON."}}}},{"id":"row_icon","component":{"Row":{"children":{"explicitList":["ic","ic_label"]},"align":"center"}}},{"id":"ic","component":{"Icon":{"name":{"literalString":"home"}}}},{"id":"ic_label","component":{"Text":{"text":{"literalString":"Home"},"variant":"caption"}}},{"id":"btn","component":{"Button":{"child":"btn_t","variant":"primary","action":{"name":"tap"}}}},{"id":"btn_t","component":{"Text":{"text":{"literalString":"Primary Button"}}}}]}}
    """
