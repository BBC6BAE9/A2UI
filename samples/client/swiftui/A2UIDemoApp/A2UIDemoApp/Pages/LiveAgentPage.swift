...
private let demoItems: [DemoItem] = [
    ...
    .init(id: "demo-multichoice", title: "ChoicePicker", description: "Select valid options from a list.", dataPath: "galleryData/favorites"),
    .init(id: "demo-multichoice-chips", title: "ChoicePicker (Chips)", description: "Select options using chips.", dataPath: "galleryData/favoritesChips"),
    .init(id: "demo-multichoice-filter", title: "ChoicePicker (Filterable)", description: "Search and filter options.", dataPath: "galleryData/favoritesFilter"),
